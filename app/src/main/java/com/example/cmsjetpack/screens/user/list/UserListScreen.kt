...
import com.example.cmsjetpack.screens.user.add.UserAddSheet
import com.example.cmsjetpack.screens.user.list.elements.UserListItem
...
fun UserListScreen(
    ...
    val users by viewModel.items.collectAsState()
    ...
    if (openAddUserSheet.value) {
        Log.d("value", "${openAddUserSheet.value}")
        UserAddSheet(
